"""Decode tables for CelesTrak SATCAT's abbreviated codes.

Transcribed directly from CelesTrak's own published references (not
guessed): OBJECT_TYPE values confirmed against live SATCAT records
(records.php?CATNR=... for known payloads/rocket bodies/debris), and
OWNER_LABELS from https://celestrak.org/satcat/sources.php in full. Any
code CelesTrak adds later that isn't in this table falls back to the raw
code itself (see handler.py) rather than failing.
"""
